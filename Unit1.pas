   ...
   then begin
     ...
     if not Layout1.BoundsRect.Contains (T.CenterPoint)
      then begin
             ...
             Button1.Text:='Play again !'+LineFeed+LineFeed+' Score '+IntToStr(Trunc(Circle1.TagFloat))+LineFeed+'Top Score '+IntToStr(Trunc(Layout1.TagFloat));
              if Layout1.TagFloat < Circle1.TagFloat
                then  Layout1.TagFloat:=Circle1.TagFloat;
              Button1.Visible:=True;
              Label1.Text:='FireMonkey XE7 Jumpe';
           end
